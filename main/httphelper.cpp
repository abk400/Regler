...
static const char* HTML_NAVIGATION = R"nav(
<ul style="padding: 0px;width: 270px;font-size: 14px;margin: 0px auto;margin-top: 1px;border-bottom-style: dashed;padding-bottom: 12px;padding-top: 10px;border-bottom-width: 1px;">
  <li style="display: inline;  "><a style="color: #cd7814; font-family: arial;text-decoration: none;" href="wifi">Wi-fi Settings</a></li> |
  <li style="display: inline;  "><a style="color: #cd7814; font-family: arial;text-decoration: none;" href="server_join"> Device Settings</a></li> |
  <li style="display: inline; "><a style="color: #cd7814; font-family: arial;text-decoration: none;" href="status">Status Info</a></li>
</ul>
)nav";
